...
public class Fireball : MonoBehaviour
{
    ...
    /// <summary>敵全体に与えるダメージ量</summary>
    [SerializeField, Header("敵に与えるダメージ量")] private int damageToEnemyAmount;

    /// <summary>味方に与えるダメージ量</summary>
    [SerializeField, Header("味方に与えるダメージ量")] private int damageToAllyAmount;

    /// <summary>味方を回復する量</summary>
    [SerializeField, Header("味方を回復する量")] private int healToAllyAmount;
    ...
    /// <summary>火の玉の効果結果を外部に通知するイベント</summary>
    public event Action<FireballEffectResult> OnEffectTriggered;
    ...
    private void TriggerRandomEffect()
    {
        ...
        var effectResult = new FireballEffectResult();
...
/// <summary>
/// 火の玉が発動した効果の内容を保持するデータクラス。
/// </summary>
public class FireballEffectResult
{
    public FireballEffectType effectType;  // 発動した効果の種類
    public int effectAmount;   // 効果の数値量（ダメージ量・回復量）
}