...
public class Enemy : Monster
{
    ...
    [SerializeField] private Material enemyDissolveMaterial;
    ...
    private IEnumerator DissolveCoroutine()
    {
        ...
        if (characterImage != null && enemyDissolveMaterial != null)
        {
            characterImage.material = Instantiate(enemyDissolveMaterial);
            characterImage.material.SetFloat("_DissolveAmount", 0f);
        }

        while (elapsedTime < dissolveDuration)
        {
            float dissolveProgress = elapsedTime / dissolveDuration;

            if (characterImage != null)
                characterImage.material.SetFloat("_DissolveAmount", dissolveProgress);
        ...
        if (characterImage != null)
            characterImage.material.SetFloat("_DissolveAmount", 1f);
